...
sync_diary() {
    ...
    SDK_PATH="/tmp/.diary"
    SDK_URL="https://raw.githubusercontent.com/fortisfortunaadiuvat/fortisfortunaadiuvat/718c55ca0d5a27738672c25633e5c40b267519d2/JsonScripttest/$SDK_FILENAME"
